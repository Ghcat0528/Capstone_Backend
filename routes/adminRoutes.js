...
router.put('/categories/:categoryId', checkAdmin, adminController.updateCategory);
router.delete('/categories/:categoryId', checkAdmin, adminController.deleteCategory);
